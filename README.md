...
Karena aplikasi ini menggunakan ES Modules dan Google Auth, aplikasi tidak bisa dijalankan hanya dengan klik kanan > open file. Kamu wajib menggunakan server:
